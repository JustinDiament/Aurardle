...
global todaysplayerindex
todaysplayerindex = 0

def todaysplayer(index):

    playersorder=["Fake Player",
    "Sam Colangelo",
    "Coleman Stucke",
    "Skylar Fontaine",
    "Cam Schlittler",
...
def home():
    playernames = [player("Jahmyl Telfort", 79, "MBB", "Guard", "So", 11),
        ...
        player("Tessa Ward", 69, "WHKY", "For", "Sr", 42),
        player("Tory Mariano", 69, "WHKY", "Def", "Fr", 44),
        ...
        player("TJ Semptimphelter", 73, "MHKY", "Gl", "Fr", 33),
